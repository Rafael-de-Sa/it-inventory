    ...
    @php
        $areas = [
            ...
            [
                ...
                'texto' => 'Registre entregas, devoluções, trocas e ocorrências, e acompanhe o histórico por funcionário, setor e equipamento.',
            ],
            [
                'icone' => 'fa-solid fa-file-signature',
                'titulo' => 'Termos',
                'texto' => 'Gere termos de responsabilidade, devolução e troca padronizados para funcionários próprios e terceirizados.',
            ],
        ];
    @endphp

@php
    ...
    $nomeEmpresaExibicao = $nomeFantasiaEmpresa ?: $razaoSocialEmpresa;
@endphp
...
<div class="secao-texto">
    O(a) Sr(a). <strong>{{ $nomeCompletoMaiusculo }}</strong>
    @if (!empty($funcionario->matricula))
        , identificado(a) internamente sob a matrícula
    ...
    previstas no contrato de prestação de serviços e na legislação aplicável.
</div>
...
<div class="secao-texto" style="margin-top:18px;">
    ...
    estou ciente de que qualquer divergência poderá ser objeto de apuração entre a empresa
    contratante e a empresa prestadora de serviços.
</div>
